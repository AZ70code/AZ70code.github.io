(() => {
    ...
    function showMore() {
        window.addEventListener("load", (function(e) {
            ...
            function getHeight(showMoreBlock, showMoreContent) {
                let hiddenHeight = 0;
                const itemHeight = showMoreContent.querySelector("[data-item]").clientHeight;
                ...
                if ("items" === showMoreType) {
                    ...
                    const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : itemHeight;
    ...
    function initSlidersHero() {
        ...
        if (document.querySelector(".facilities__slider")) new core(".facilities__slider", {
            modules: [ Pagination, Scrollbar, Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            speed: 800,
        ...
        if (document.querySelector(".gallery__slider")) new core(".gallery__slider", {
            ...
            navigation: {
                prevEl: ".gallery__navigation .arrow-prev",
                nextEl: ".gallery__navigation .arrow-next"
            },
            breakpoints: {
                480: {
                    slidesPerView: 2,
        ...
        if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
            ...
            autoHeight: true,
            navigation: {
                prevEl: ".reviews__navigation .arrow-prev",
                nextEl: ".reviews__navigation .arrow-next"
            },
            scrollbar: {
    ...
    function initSlidersSpaces() {
        if (document.querySelector(".spaces__slider")) new core(".spaces__slider", {
            ...
            navigation: {
                prevEl: ".spaces__navigation .arrow-prev",
                nextEl: ".spaces__navigation .arrow-next"
            },
            scrollbar: {
