...
let slider_projects = new Swiper('.projects__slider', {
	...
	// Arrows
	navigation: {
		nextEl: '.projects__arrows .projects__arrow--next',
		prevEl: '.projects__arrows .projects__arrow--prev',
	},
	breakpoints: {
		380: {
			slidesPerView: 2,
...
let slider_testimonial = new Swiper('.testimonial__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 30,
	...
	// Arrows
	navigation: {
		nextEl: '.testimonial__arrows .testimonial__arrow--next',
		prevEl: '.testimonial__arrows .testimonial__arrow--prev',
	},
});
...
function counter(value, info) {
    let count = 0;
    let counter = setTimeout( function countValue() {
        if(count < value) {
            count++;
             info.textContent=`${count}`;
            counter = setTimeout( countValue, 100);
        }
    }, 100)
} 
	//================anim scroll=========================================
const infoProject = document.querySelector('#project');
const valueProject = infoProject.getAttribute('data-value');
const infoExp = document.querySelector('#exp');
const valueExp = infoExp.getAttribute('data-value');
const infoGoing = document.querySelector('#ongoing');
const valueGoing = infoGoing.getAttribute('data-value');

const animItems = document.querySelectorAll('.info-about__value');
        ...
        for (let index = 0; index < animItems.length; index++) {
            ...
            if ((pageYOffset > animItemOffset - animItemPoint) && pageYOffset < (animItemOffset + animItemHeight)) {
                ...
                if(animItem.classList.contains('_active')) {
                    counter(valueProject, infoProject);
                    counter(valueExp, infoExp);
                    counter(valueGoing, infoGoing);
